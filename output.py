...
def output_to_csv(t_list, p_diff_list, p_correct_diff_list, flow_list, mass_flow_list, zd_list, dens_list, save_file_name):
    t_p_list = pd.DataFrame(
        {'t': t_list, 'p': p_diff_list, 'p_corrected': p_correct_diff_list, 'zd_list': zd_list, 'flow_list': flow_list, 'mass_flow_list': mass_flow_list, desn_list: dens_list}, index=None)
    try:
